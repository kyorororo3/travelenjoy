      ...
      <div className="account-wrapper">
        ...
        <div className="account-form">
          <form name='accountFrm' onSubmit={this.handleSubmit} encType='multipart/form-data'>
            ...
            <p><input type='text' name='email' placeholder='이메일을 입력해주세요.'></input></p>

            <p className='row-name'>비밀번호*</p>
            <p><input type='password' name='pwd' placeholder='영어, 숫자 조합 6~20자'></input></p>

            <p className='row-name'>비밀번호 확인*</p>
            <p><input type='password' name='pwdcheck' placeholder='위와 동일한 비밀번호 입력'></input></p>

            <p className='row-name'>이름*</p>
            <p><input type='text' name='name' placeholder='이름을 입력해주세요.'></input></p>

            <p className='row-name'>닉네임</p>
            <p><input type='text' name='nickname' placeholder='닉네임을 입력해주세요.(중복불가)'></input></p>

            <p className='row-name'>휴대폰 번호</p>
            <p><input type='text' name='phone' placeholder='-를 생략하여 입력해주세요.'></input></p>
