                        ...
                        <div className='body-info-container'> 
                            <div className='wait-myreview-wrapper'>
                                ...
                                <div className='travel-wrapper'>
                                    {unposted_list.length !== 0? unposted_list.map(tour =>  <TravelList key={tour.seq} tour={tour} />):<h5>Nothing to review</h5>}
                                </div>
                            </div>
                            <div className='done-myreview-wrapper'>
                                ...
                                <div className='review-table'>
                                    ...
                                    {myReviews.length !== 0? myReviews.map(review => <ReviewForm key={review.seq} review={review}/>):<h5>Nothing to review</h5>}
                                </div>
                            </div>
