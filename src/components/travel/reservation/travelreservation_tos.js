      ...
      <div className='travel-tos-info panel-m'>
        ...
        <div className='tos-content'>
          <div className='tos-text'>
            ...
            제 1 장 목적 및 정의
            제 1 조 (목적)
            이 약관(이하 “여행자약관”)은 주식회사 트래블앤조이(이하 “당사”)이 운영하는 “트래블앤조이” 사이트(www.travelenjoy.com) 또는 어플리케이션(Application, 이하 웹사이트와 어플리케이션을 통칭하여 “트래블앤조이 플랫폼”)을 통하여 여행자와 파트너 사이에서 체결되는 여행계약(이하 “여행계약”)의 중개와 관련하여 특히 여행자의 권리와 의무 등 법률관계를 명확히 함을 목적으로 합니다.
            제 2 조 (용어의 정의)
            이 약관에서 사용되는 용어의 정의는 다음과 같습니다.
                (1) “파트너”는 당사가 여행자에게 중개한 자로서 여행자에게 각종 여행 서비스를 제공하는 자를 말합니다.
                (2) "가이드"는 파트너 중 트래블앤조이 플랫폼을 통해 직접 여행지에서 여행자에게 투어를 제공하는 자를 말합니다. 
            ...
            여행자와 여행계약을 체결하고 서비스를 제공하는 법적 주체는 파트너이며, 당사는 트래블앤조이 플랫폼을 통하여 여행자가 원하는 날짜와 조건에 맞추어 파트너와 여행계약을 체결하고 서비스를 제공받는 것을 중개하는 업무를 수행합니다.
            제 4 조 (가이드의 독립당사자 지위)
            ...
            8. 여행자는 여행이 종료된 후 트래블앤조이 플랫폼 상에 여행 후기에 관한 게시물을 작성 및 게시할 수 있습니다. 
            ...
            2. 제1항에 정한 사전 약정은 해당 여행과 관련하여 (i) 트래블앤조이 플랫폼 내부 메시지창, (ii) 여행확인증, (iii) 상품 소개 페이지를 통하여 명시된 내용에 한정하며, 제1항 각 호의 사유가 발생하였는지 여부에 대하여 여행자와 파트너 사이에 다툼이 있는 경우, 당사가 객관적이고 중립적인 기준에 따라 이를 판단합니다.
            ...
            4. 제3항의 요건이 충족되는 경우, 파트너는 여행자의 선택에 따라 다음 각 호의 손해배상 방식 중 어느 하나의 방식으로 여행자에 대한 손해를 배상하여야 합니다.
                ...
                (2) 트래블앤조이 credit 배상: 현금이 아닌 추후 당사가 중개하는 여행계약에서 여행요금으로 사용 가능한 쿠폰 또는 포인트를 부여합니다. 대신 이를 선택하는 경우 배상 포인트는 제1호에 따라 산정된 현금배상 금액의 110% 상당으로 정합니다.
